...
def main(args):
    ...
    my_listener = MyListener(common_token_stream=token_stream, package_classes_dict=package_classes_dict) ####shaghayegh
    walker = ParseTreeWalker()
    walker.walk(t=parse_tree, listener=my_listener)

    return  my_listener.package_classes_dict
...
if __name__ == '__main__':
    ...
    packages_dict=process_file('D:/univercity/Term 1 Arshad/Architecture software systems/CodART/tests/move_method/s.java')
    print(packages_dict)
